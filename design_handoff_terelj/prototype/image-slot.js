...
(() => {
  ...
  const stylesheet =
    ...
    '  background:#fff;box-shadow:0 0 0 1.5px var(--rust,#2E6E8E),0 1px 3px rgba(0,0,0,.3);' +
    ...
    ':host([data-reframe]) .frame{box-shadow:0 0 0 2px var(--rust,#2E6E8E)}' +
    ...
    ':host([data-over]) .frame{outline:2px solid var(--rust,#2E6E8E);outline-offset:-2px;' +
    '  background:rgba(46,110,142,.12)}' +
    '.ring{position:absolute;inset:0;pointer-events:none;border:1.5px dashed rgba(0,0,0,.25);' +
    '  transition:border-color .12s}' +
    ':host([data-over]) .ring{border-color:var(--rust,#2E6E8E)}' +
